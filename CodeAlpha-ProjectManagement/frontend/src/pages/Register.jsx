          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-semibold mb-1">Get Started Fast</h3>
                  <p className="text-primary-200 text-sm">Create your account in seconds</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-primary-200 text-sm">Your data is safe with us</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-primary-200 text-sm">No credit card required</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-slate-950">
        ...
        >
          ...
          <div className="text-center lg:text-left mb-8">
            ...
            <p className="text-slate-400">Start managing your projects today</p>
          </div>
